import type { ThreadColorMap } from "../../../types/messaging";

const THREAD_COLORS: ThreadColorMap = {
...
export function getThreadColors(): ThreadColorMap {
  return { ...THREAD_COLORS };
}

export function createGetThreadColorsQuery() {
  return function getThreadColorsQuery(): ThreadColorMap {
